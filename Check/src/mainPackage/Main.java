...
public class Main{
    public static void main(String[] args) {
        ...
        for(int i = 0;i<34;i++){
            ...
            if(MiniVan.count>=0){
                System.out.println(MiniVan.count);
            }
            if(Standard.count>=0){
                System.out.println(Standard.count);
            }
            if(SUV.count>=0){
                System.out.println(SUV.count);
            }
            if(Economy.count>=0){
            ...
            for(Customer customer:customers){
                ...
                if(i==(buyingDay+numberOfDaysRented)){
                    rrlist.get(k).returnCar(customer);
